...
\begin{itemize}
  \item Idea: Split up Supervisor in Single Agents
  \item Through Process -> Two General Supervisor Architecture with Two States
  \item First: Gen1 State \& Agents
  \item Then: Property Extraction
  \item Last: Gen1v2
\end{itemize}
\subsection{ReAct}
\label{subsec:react}
