...
\begin{itemize}
  \item Disambiguation no problem, as type of entity is used within search terms -> Corfe Castle example
\end{itemize}
...
\begin{itemize}
  \item Limitation of one Dataset
  \item Embedding Model Discussion -> Not detected as problem, mainly wrong search term
  \item Manual Prompt Engineering -> Auto Prompt Engineering cost intense.
  \item synthIE Limitation on correct URIs, no real URI retrieval challenge
\end{itemize}
