...
\begin{figure}[tp]
  ...
  \caption[\textit{baseline architecture} showing the pipeline approach with specialised agents for each step of the \ac{cIE} process]{\textit{baseline architecture} showing the pipeline approach with specialised agents for each step of the \ac{cIE} process (self-created)}
...
\begin{figure}[tp]
  ...
  \caption[Splitted supervisor architecture showing the decomposition of the supervisor agent into specialised sub-agents for better task management]{Splitted supervisor architecture showing the decomposition of the supervisor agent into specialised sub-agents for better task management (self-created)}
...
\begin{figure}[tp]
  ...
  \caption[Simplified splitted supervisor architecture showing a streamlined version of the supervisor decomposition with optimised agent interactions]{Simplified splitted supervisor architecture showing a streamlined version of the supervisor decomposition with optimised agent interactions (self-created)}
